...
class _RestClient implements RestClient {
  ...
  Future<List<StoryModel>> getStories({String? categoryId}) async {
    ...
    final _options = _setStreamType<List<StoryModel>>(
    ...
    late List<StoryModel> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) => StoryModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
  ...
  Future<StoryModel> getStory({required String id}) async {
    ...
    late StoryModel _value;
    try {
      _value = StoryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<CategoryTypeModel>> getCategoriesTypes({
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CategoryTypeModel> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    CategoryTypeModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<CategoryTypeModel> getCategoryType({required String id}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CategoryTypeModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'category_type/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CategoryTypeModel _value;
    try {
      _value = CategoryTypeModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<void> createCategoryToStory({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'story/${storyId}/categories/${categoryId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<StoryModel> getStoryPopular({String? filter}) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<List<StoryModel>> getStoriesPopular({String? filter}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'filter': filter};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<List<CategoryModel>> getSearchCategories({
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'query': query, r'type': type};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CategoryModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
  ...
  Future<ReadsStatsModel> getReadsStats() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ReadsStatsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'stats/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ReadsStatsModel _value;
    try {
      _value = ReadsStatsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
